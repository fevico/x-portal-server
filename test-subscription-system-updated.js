 ...
 * Run this after seeding the subscription packages
 */
...
/**
 * 8. GET SCHOOL PLAN DETAILS (School Admin)
 * GET /subscription/school-plan
 * Headers: Authorization: Bearer <school_admin_token>
 */
const getSchoolPlanExample = {
  method: 'GET',
...
/**
 * 10. DELETE PACKAGE (SuperAdmin - Soft Delete)
...
/**
 * 11. MANUAL PAYMENT VERIFICATION (SuperAdmin)
 ...
 * 9. Manual verification available for failed webhook cases
 */
 ...
 * ✅ Manual payment verification for edge cases
 */

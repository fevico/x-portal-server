...
export class CommunicationController {
    ...
    async createEvent(@Body() createEvent: CreateEvent, @Request() req: any): Promise<any> {
    ...
    @Get('events/:eventId')
    @UseGuards(JwtAuthGuard)
    async getEventById(@Request() req: RequestExpress, @Param('eventId') eventId: string): Promise<any> {
        const user = req.user as AuthenticatedUser;
    ...
    @UseGuards(JwtAuthGuard)
    async updateEvent(@Request() req: RequestExpress, @Param('eventId') eventId: string, @Body() updateEvent: updateEvent): Promise<any> {
        const user = req.user as AuthenticatedUser;

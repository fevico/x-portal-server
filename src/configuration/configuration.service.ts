...
export class ConfigurationService {
    ...
    async updateSchoolInformation(body: UpdateSchoolInfoDto, user: AuthenticatedUser, logo: Express.Multer.File){
        ...
        try {  
            ...
            if(!school) throw new NotFoundException("School data not found for this user")
            return school;
        } catch (error) {
    ...
    addSchoolGradeScheme(body: any, schoolId: string) {
        const { scoreStartPoint, scoreEndPoint, remark, teacherComment, principalComment, markingSchemeId } = body;
